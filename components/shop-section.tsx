...
const shopItems = [
  {
    ...
    price: 'Rs. 500/-',
    weight: '500ml - Bottle',
    image: '/honey-jar-1.jpg'
  },
  {
    id: 2,
    name: 'Wild Forest Honey',
    description: 'A rich, dark honey collected from wildflowers in pristine forest regions. Bold flavor with earthy undertones.',
    details: 'Health Benefits: - Rich in enzymes and natural minerals. Perfect for immune support and daily wellness.',
    origin: 'Himalayan Forests',
    price: 'Rs. 650/-',
    weight: '500ml - Bottle',
    image: '/honey-jar-2.jpg'
  },
]
...
export default function ShopSection() {
  ...
  const nextSlide = () => {
    setCurrentSlide((prev) => (prev + 1) % shopItems.length)
  }

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + shopItems.length) % shopItems.length)
  }
        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-6 md:p-10">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-sm flex items-center justify-center">
                <div className="w-48 h-48 bg-gradient-to-br from-[#c9a227]/20 to-[#9a7b1c]/10 rounded-lg flex items-center justify-center">
                  <span className="text-6xl">🍯</span>
                </div>
              </div>
              <div className="absolute bottom-4 left-4 text-sm text-[#c9a227]">
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-4">
                <div>
                  <span className="text-xs text-[#c9a227]/60 tracking-widest">FLAVOR</span>
                ...
                <div className="flex items-center gap-8 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#c9a227] text-lg font-medium">{shopItems[currentSlide].price}</p>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="mt-6 px-8 py-3 bg-[#c9a227] text-[#0a0a0a] text-sm tracking-wide font-medium hover:bg-[#e8c547] transition-all duration-300"
                >
                  Add To Cart
                </motion.button>
              </div>
