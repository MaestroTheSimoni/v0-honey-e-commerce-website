        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-[#f5f0e6]/70 leading-relaxed">
              <p>
              L'Apicoltura NomeAzienda si impegna da anni a far capire al consumatore la nostra filosofia di lavoro e cosa c'è dietro al barattolino di miele che si acquista: Rispetto, Amore, Etica, Impegno, Semplicità. 
